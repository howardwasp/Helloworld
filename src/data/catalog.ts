...
export const SAMPLE_LAYER_IDS = [] as const
...
export const NEWS_SOURCES: NewsSourceTab[] = [
  ...
  { id: 'gdelt', label: 'GDELT', accent: '#6b3fa0' },
  { id: 'ofac', label: 'OFAC', accent: '#8a5a12' },
  { id: 'ioda', label: 'IODA', accent: '#7c4a1a' },
